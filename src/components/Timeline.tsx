...
export const kindMeta: Record<TimelineKind, { tint: string; glyph: string }> = {
...
/** The circular kind marker shared by the timeline and the activity feed. */
export function KindMarker({ kind }: { kind: TimelineKind }) {
